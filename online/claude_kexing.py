...
if __name__ == "__main__":
   result_test10 = optimize_cutting(
    L = 12000,
    demands = [
        [50, 2000],
        [75, 1800],
    ...
    # # 写入文件
    # with open('result1_no_cut.json', 'w', encoding='utf-8') as f:
    #     f.write(result1)
    # print("结果已保存到: result1_no_cut.json")

    # # 示例2: 去头50mm，去尾30mm
    # print("\n" + "=" * 80)
    # print("示例2: 去头50mm，去尾30mm")
    # print("=" * 80)
    # result2 = optimize_cutting(
    #     L=6000,
    #     demands=[
    #         [1430, 80],
    #         [1230, 96],
    ...
    # # 写入文件
    # with open('result2_with_cut.json', 'w', encoding='utf-8') as f:
    #     f.write(result2)
    # print("结果已保存到: result2_with_cut.json")

    # print("\n✓ 所有结果已保存，请查看JSON文件")

    # 示例3: 去头100mm，去尾100mm
    # print("\n" + "=" * 80)
    # print("示例3: 去头100mm，去尾100mm")
    # print("=" * 80)
